...
const Home = ()=>{
    return (
        ...
        <Link to={'/local'}><Button className="w-52 h-14 p-5 gap-5 hover:bg-slate-300 hover:text-black slide-to-left">Online multiplayer<Globe size={30}></Globe></Button></Link>
        </div>
        </>
    )
}
